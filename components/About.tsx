                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="w-full md:w-1/2 flex justify-center">
                        <div className="bg-white p-10 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center">
                            <img src="/logo.png" alt="MS Realty" className="w-64 h-auto object-contain mb-4" />
                        </div>
                    </div>

                    {/* Right Side - Content */}
                    <div className="w-full md:w-1/2">
                        <h3 className="text-2xl font-bold text-blue-500 mb-6 border-b-2 border-blue-500 pb-2 inline-block">Who We Are</h3>
